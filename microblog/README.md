...
In order to make the app creation happen only once, we are going to put everything inside a function and return the app.
...
And that's it! This function will be called every time the app is created.